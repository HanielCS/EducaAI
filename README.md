...
![EducaAI Logo](https://i.imgur.com/SEU-LOGO-URL.png) O EducaAI é um aplicativo móvel, construído em Flutter, que funciona como um tutor de Inteligência Artificial para alunos do Ensino Fundamental. A sua principal característica é adaptar as suas respostas com base na **Base Nacional Comum Curricular (BNCC)** e no perfil de aprendizagem único de cada aluno.
